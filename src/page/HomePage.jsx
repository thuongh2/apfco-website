  ...
  return (
    ...
    <div>
          ...
          <div className="mt-12 absolute grid grid-cols-8 gap-6 w-full">
            ...
            <div className="col-start-5 col-span-3 text-justify">
              <div>
                ...
                <span className="text-[18px] text-[#667085] leading-[30px]">
                  Kể từ tháng 12/2003, thương hiệu APFCO đã và đang được
                </span>
                <br />
                <span className="text-[18px] text-[#667085] leading-[30px]">
                  nhiều đơn vị khách hàng trên thị trường trong và ngoài nước
                </span>
                <br />
                <span className="text-[18px] text-[#667085] leading-[30px]">
                  đón nhận bởi chất lượng sản phẩm (nguồn nguyên liệu tươi,
                </span>
                <br />
                <span className="text-[18px] text-[#667085] leading-[30px]">
                  sản phẩm bột đạt tiêu chuẩn khắt khe, bảo quản trong môi
                </span>
                <br />
                <span className="text-[18px] text-[#667085] leading-[30px]">
                  trường chuyên nghiệp), áp dụng kĩ thuật - công nghệ tiên
                </span>
                <br />
                <span className="text-[18px] text-[#667085] leading-[30px]">
                  tiến (ISO 9001:2015), khẳng định uy tín lâu dài.
                </span>
                <br />
              </div>
            </div>
      ...
      <div className="bg-hero mt-20 py-14">
        ...
        <img className="opacity-40 mt-5" src="./image/Untitled-1.png" alt="" />
      </div>
    </div>
    <Blog/>
    <Footer/>
